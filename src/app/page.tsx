      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-xl shadow-xl p-6">
          <h1 className="text-3xl font-bold mb-6 text-center text-gray-800">
            🍺 Chat with Thud from The Space Bar
          </h1>
          ...
          <div className="h-[400px] overflow-y-auto mb-6 p-4 bg-gray-50 rounded-lg border">
            {messages.length === 0 && (
              <div className="text-center text-gray-500 mt-20">
                <p className="text-lg">👋 Hey there! I'm Thud from The Thirsty Tentacle.</p>
                <p className="mt-2">Need help with The Space Bar? Just ask me anything!</p>
              </div>
            )}
